...
final class WelcomeViewController: UIViewController {
    ...
    let createWalletButton: UIButton = {
        ...
        button.setTitle(NSLocalizedString("welcome.createWallet.button.title", value: "CREATE A NEW WALLET", comment: ""), for: .normal)
    ...
    @IBAction func start() {
        delegate?.didPressCreateWallet_Condition(in: self)
