...
final class WalletCoordinator: Coordinator {
    ...
    func start(_ entryPoint: WalletEntryPoint) {
        ...
        case .createInstantWallet:
            createInstantWallet()
        case .createInstantWallet_Condition:
            createInstantWallet_Condition()
        }
    }
    ...
    func createInstantWallet_Condition() {
        
        configureWhiteNavigation()
        let controller = ConditionWalletConditionViewController()
        controller.delegate = self
...
extension WalletCoordinator: WelcomeViewControllerDelegate {
    ...
    func didPressCreateWallet_Condition(in viewController: WelcomeViewController) {
        createInstantWallet_Condition()
    }
...
extension WalletCoordinator: WalletConditionViewControllerDelegate {
