...
final class TokensCoordinator: Coordinator {
    ...
    lazy var masterViewController: WalletViewController = {
        ...
        masterViewController.navigationItem.leftBarButtonItem = UIBarButtonItem(customView: qrcodeButton)
    ...
    @objc func qrReader() {
        ...
        //coordinator.delegate = self as! ScanQRCodeCoordinatorDelegate
    ...
    @objc func addToken() {
        ...
        controller.navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .cancel, target: self, action: #selector(dismiss))
