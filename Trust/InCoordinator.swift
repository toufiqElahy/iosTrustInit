...
struct CoinTypeViewModel {
    ...
    var server: RPCServer {
        ...
        case .aion: return RPCServer.aion
        }
    }
}
...
class InCoordinator: Coordinator {
    ...
    var dexCoordinator: DexCoordinator? {
        return self.coordinators.compactMap{ $0 as? DexCoordinator }.first
    }
    ...
    func showTabBar(for account: WalletInfo) {
        ...
        dexCoordinator.rootViewController.tabBarItem = viewModel.dexsBarItem
        dexCoordinator.start()
        addCoordinator(dexCoordinator)
        ...
        tabBarController.viewControllers = [
            ...
            dexCoordinator.navigationController.childNavigationController,
